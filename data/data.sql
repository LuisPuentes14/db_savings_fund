...
INSERT INTO loan_types (name, monthly_interest, term_months, created_by)
VALUES ('ORDINARIO', 1.00, 60, 'admin'),
       ('EXTRA ORDINARIO', 1.00, 4, 'admin'),
       ('RECREATIVO', 1.00, 12, 'admin'),
       ('COMPRA', 0, 3, 'admin');
...
-- 🔟 Detalle de Pagos
INSERT INTO payments_details (payment_id, type, amount_paid, number_installment)
VALUES (1, 'CONTRIBUCION', 15000.00,0),
       (1, 'COMPRA', 1667.00, 1),
       (2, 'CONTRIBUCION', 20000.00,0),
       (2, 'COMPRA', 1000.00,1),
       (3, 'CONTRIBUCION', 50000.00,0)
